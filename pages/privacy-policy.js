    ...
    <>
      ...
      <section className="layout-pt-lg layout-pb-lg">
        <div className="container">
          ...
          <p className="text-15 text-dark-1 mt-5">This Privacy Policy outlines how www.xplorz.com collects, uses, discloses, and protects your personal information. We are committed to safeguarding your privacy and complying with applicable data protection laws.</p>
          ...
          <p className="text-15 text-dark-1 mt-5">If you have any questions or concerns about this Privacy Policy, please contact us at support@xplorz.com</p>
        </div>
      </section>
      {/* End terms section */}
