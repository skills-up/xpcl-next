    ...
    <>
      ...
      <div className='py-30 px-30 rounded-4 bg-white shadow-3'>
        ...
        <ViewTable
          data={refund}
          onEdit={() =>
            router.push('/dashboard/refunds/edit/' + router.query.view)
          }
          onDelete={() => {
          ...
          extraButtons={filterAllowed([
            {
              ...
              permissions: ['refunds.pdf'],
            },
          ])}
        />
        <hr className='my-4' />
        {hasPermission('refunds.audit-trail') && (
          <div>
...
ViewRefunds.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
