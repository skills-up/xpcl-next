...
const AirlineOrganizationMarkup = () => {
  ...
  const getAirlineOrganizationMarkup = async () => {
    const response = await getList('airline-organization-markup');
    if (response?.success) {
      setAirlineOrganizationMarkup(response.data);
    } else {
      sendToast(
        'error',
              ...
              options={[
                {
                  ...
                  onClick: () =>
                    window.location.assign(
                      '/dashboard/airline-organization-markup/view/' +
                ...
                },
                {
                  ...
                  onClick: () =>
                    window.location.assign(
                      '/dashboard/airline-organization-markup/edit/' +
                        data.row.original.id
                    ),
                ...
                },
                {
                  ...
                  onClick: () =>
                    window.location.assign(
                      '/dashboard/airline-organization-markup/clone/' +
                        data.row.original.id
                    ),
                  icon: <IoCopyOutline />,
                },
...
export default AirlineOrganizationMarkup;
