...
const ViewClientTravellers = () => {
  ...
  return (
    <>
      <Seo pageTitle='View Client Traveller' />
      {/* End Page Title */}

      <div className='row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32'>
                <div className='col-12'>
                  <h1 className='text-30 lh-14 fw-600'>View Client Traveller</h1>
                  <div className='text-15 text-light-1'>
                    Get extended details of a client traveller.
                  </div>
                </div>
                {/* End .col-12 */}
              </div>
...
ViewClientTravellers.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;

export default ViewClientTravellers;
