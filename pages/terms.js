        ...
        <div className="container">
          ...
          <p className="text-15 text-dark-1 mt-5">
             <ul className="list-disc">
              ...
              <li>We recommend obtaining travel insurance to cover cancellation fees and other potential losses.</li>
              <li>We reserve the right to cancel bookings if full payment is not received by the specified deadline.</li>
              <li>In case of any refunds, the refund amount will be credited to the original payment method, within 14 business days.</li>
            </ul>
          </p>
