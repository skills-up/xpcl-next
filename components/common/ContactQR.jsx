      ...
      <div className='section-bg pb-50 bg-light'>
        <div className='container'>
          <div className='row items-center'>
            ...
            <div className='col-lg-7 lg:mt-30'>
              ...
              <div className='row items-end y-gap-20'>
                <div className='col-lg-4'>
                  <img className='qr' src='/img/backgrounds/qr.png' />
                </div>
                <div className='col-lg-8 d-flex gap-3 mb-20 justify-center items-center lg:justify-start lg:mt-10'>
                  <img
