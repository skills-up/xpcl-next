    ...
    <div id='contact-started'>
      ...
      <div className='section-bg main-container pb-50'>
        <div className='container'>
          ...
          <div className='col-lg-6 mt-80'>
            <h3 className='text-light-4 mb-10'>
              Grab all the corporate benefits by creating your account now
            </h3>
            <div className='d-inline-block started-button col-lg-12 pr-40 lg:pr-0 mt-20'>
              <Link
                href='/hotel/hotel-list-v5'
                className='button py-20 col-lg-12 text-18 text-center bg-blue-1 text-white'
              >
                Find Deals
              </Link>
            </div>
          ...
          <div className='features'>
            ...
            <div className='row mt-45 x-gap-60'>
              {features.map((element, index) => (
                <div className='feature col-lg-4'>
                  <span className='text-40 fw-700 text-white feature-number'>
                    {index + 1}
                  </span>
                  <h2 className='text-light-4 mt-30'>{element.title}</h2>
                  <h5 className='text-light-4 fw-200 mt-20'>{element.subtitle}</h5>
                </div>
              ))}
            </div>
            <div className='d-inline-block started-button col-lg-3 pr-40 lg:pr-0 mt-60'>
              <Link
                href='/hotel/hotel-list-v5'
                className='button py-10 col-lg-11 text-18 text-center bg-blue-1 text-white'
              >
                Create Now
              </Link>
            </div>
