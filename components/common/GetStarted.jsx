import { IoDesktopSharp, IoLogInSharp } from 'react-icons/io5';
  ...
  const cards = [
    {
      ...
      subtitle:
        'Perfect for booking flights, hotels and chauffeur driver cars all over the world',
      points: [
    ...
    },
    {
      ...
      subtitle: 'Super important when you double and triple book for flights',
      points: [
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
    ...
    },
    {
      ...
      subtitle:
        'All invoices are autogenerated and added to the running ledger the moment the travel is booked. All Invoices are GST Compliant and work seamlessly with most accounting systems',
      points: [
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
    ...
    },
    {
      ...
      subtitle:
        'We know how critical your meetings are - and we also know how frequently plans change or get cancelled - Hence we have a dedicated support team to assist with these changes',
      points: [
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
    ...
    },
    {
      ...
      subtitle: 'When you sign up with us, a primary and single point of contact',
      points: [
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
        'Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod',
